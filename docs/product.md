...
PDF transfer, document analysis, time-aware written lesson generation, normal lesson reading, and interactive presentation mode are currently implemented. The remaining items are product objectives.
