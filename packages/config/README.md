...
The package owns the shared PDF policy: MIME/extension hints, the 15 MiB byte limit, a small multipart-envelope allowance, and the 120-second mobile upload timeout. These constants keep mobile UX and Worker enforcement aligned. Mobile checks remain convenience validation; the Worker independently validates every upload.
